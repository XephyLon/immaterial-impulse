...
QtObject {
    ...
    function buildRequestData(model: AiModel, messages, systemPrompt: string, temperature: real, tools: list<var>, filePaths) { throw new Error("Not implemented") }
    ...
    function buildScriptFileSetup(filePaths) { return "" } // Default: no setup
