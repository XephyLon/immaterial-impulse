...
Item {
    ...
    property bool showDate: Config.ready ? Config.options.appearance.clock.showDesktopDate : true
    ...
    Loader {
        ...
        onLoaded: {
            ...
            if (item && item.hasOwnProperty("showDate")) item.showDate = root.showDate
        }
