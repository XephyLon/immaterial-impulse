...
ColumnLayout {
    ...
    property bool showDate: Config.ready ? (root.isLockscreen ? Config.options.appearance.clock.showLockscreenDate : (Config.options.appearance.clock.useSameStyle ? Config.options.appearance.clock.showLockscreenDate : Config.options.appearance.clock.showDesktopDate)) : true
