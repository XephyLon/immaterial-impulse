...
Item {
    ...
    property real fontSize: Config.options.cheatsheet.typingTest.fontSize
    property int visibleLines: Config.options.cheatsheet.typingTest.visibleLines
    property string caretStyle: Config.options.cheatsheet.typingTest.caretStyle
    property bool blindMode: Config.options.cheatsheet.typingTest.blindMode
    property bool highlightCurrentWord: Config.options.cheatsheet.typingTest.highlightCurrentWord
    property bool smoothMotion: Config.options.cheatsheet.typingTest.smoothCaret
