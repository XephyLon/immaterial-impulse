...
Item {
    ...
    property string layoutId: Config.options.cheatsheet.typingTest.keyboard.layout
    property bool highlightNext: Config.options.cheatsheet.typingTest.keyboard.highlightNextKey
    ...
    property real keySpacing: Appearance.spacing.space75
