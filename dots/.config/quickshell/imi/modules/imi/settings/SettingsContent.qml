...
Item {
    ...
    property var pages: {
        let list = [
            ...
            { name: Translation.tr("Wallpaper & Desktop"), icon: "texture", component: Qt.resolvedUrl("pages/BackgroundConfig.qml"), sections: [Translation.tr("Wallpaper"), Translation.tr("Clock"), Translation.tr("Widgets"), Translation.tr("Wallpaper selector")] },
