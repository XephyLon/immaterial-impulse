...
""",
    # From caelestia-dots/caelestia (hypr/hyprland/animations.lua); same hl DSL,
    # minus its hl.config animations-enabled header (that toggle is managed by Settings).
    "caelestia": """\
