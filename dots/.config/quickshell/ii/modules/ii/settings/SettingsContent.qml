...
Item {
    ...
    property var pages: {
        let list = [
            ...
            { name: Translation.tr("Wallpaper & Desktop"), icon: "texture", component: Qt.resolvedUrl("pages/BackgroundConfig.qml"), sections: [Translation.tr("Wallpaper"), Translation.tr("Clock"), Translation.tr("Custom Image"), Translation.tr("Widgets"), Translation.tr("Wallpaper selector")] },
            ...
            { name: Translation.tr("Sidebars & Panels"), icon: "side_navigation", component: Qt.resolvedUrl("pages/SidebarsPanelsConfig.qml"), sections: [Translation.tr("Left Sidebar"), Translation.tr("Right Sidebar"), Translation.tr("Overview"), Translation.tr("Overlay"), Translation.tr("On-screen display")] },
