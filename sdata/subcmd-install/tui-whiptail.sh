#!/usr/bin/env bash
# tui-whiptail.sh — whiptail menu front-end for the installer (C1/C5 of the
# "Install TUI" plan). This is the FALLBACK front-end: tui.sh (fzf) execs this
# when fzf is unavailable or there is no TTY. Meant to be RUN, not sourced:
